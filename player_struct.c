...
#include <stdlib.h>
#include <time.h>
/*This program is designed to ask the user to input the number of players
that are playing a game, and ask the user to assign a player type to each
player. The program then generates each player by using structs. The program
sets the starting values of the player type to the corresponding player type.
*/
